                                            ...
                                            <div class="table">
                                                ...
                                                <div class="table-cell">
                                                    ...
                                                    <div class="cart-button">
                                                        <a class="add-to-cart" href="javascript:void(0);" data-id='{{ $product->sku }}' data-price='{{ $product->price}}'  data-productid="{{$product->id}}" data-weight="{{$product->weight}}" data-size='{{$product->size}}' data-name='{{ $product->product_name}}' data-imageurl='{{asset('/uploads/productimages/'.$product->product_image) }}'>
                                                            + ADD TO
                                                        </a>
                                                    </div>
                                                </div>
